...
plan = build_bridge_plan(packet, cwd="/home/example/projects/demo")
...
plan = build_bridge_plan(packet, cwd="/home/example/jarvis")
...
token_packet = classify_request("remember my API key <example-api-key> for later")
token_plan = build_bridge_plan(token_packet, cwd="/home/example/jarvis")
...
require_raises("bad packet rejected", lambda: build_bridge_plan(bad_packet, cwd="/home/example/jarvis"), "development packets must target GJC")
