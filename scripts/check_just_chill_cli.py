...
sensitive = remember_command("remember my API key sk-test-1234567890 for later")
...
sensitive_fake_token = remember_command("remember my API key sk-test-1234567890 for later", approval_token="x")
...
sensitive_valid_token = remember_command("remember my API key sk-test-1234567890 for later", approval_token="approval://cli-sensitive-approval-001")
